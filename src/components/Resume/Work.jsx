...
function Work() {
  return (
    <div className='px-6 md:px-8 ml-2 w-full'>
        <ul className='list-disc text-justify'>
            <li>
                <div className='flex flex-row justify-between'>
                    <div className="flex flex-col w-full mr-4">
                        <p className='text-[tomato] font-bold text-lg'>UPOSTAL CORPORATION OF KENYA, Nairobi — ICT Intern</p>
                        <ul className='list-disc text-justify font-light text-xs leading-4 md:leading-8'>
